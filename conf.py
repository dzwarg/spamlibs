# -*- coding: utf-8 -*-
#
# spamlibs documentation build configuration file, created by
# sphinx-quickstart on Sat Aug 25 16:50:10 2012.
#
...
latex_documents = [
  ('index', 'spamlibs.tex', u'spamlibs Documentation',
   u'David Zwarg', 'manual'),
]
...
man_pages = [
    ('index', 'spamlibs', u'spamlibs Documentation',
     [u'David Zwarg'], 1)
]
...
texinfo_documents = [
  ('index', 'spamlibs', u'spamlibs Documentation',
   u'David Zwarg', 'spamlibs', 'One line description of project.',
   'Miscellaneous'),
]
